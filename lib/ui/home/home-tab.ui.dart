...
import 'package:mxe_mobile/ui/home/wallet/wallet.ui.dart';
...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return BaseView<HomeTabViewModel>(
      ...
      onModelReady: (m) =>
          {_tabController.animateTo(m.selectedIndex), m.getInflowAndOutFlow()},
          ...
          child: DefaultTabController(
              ...
              child: Scaffold(
                  ...
                  body: NestedScrollView(
                    ...
                    body: TabBarView(
                      controller: _tabController,
                      children: const [FinancePage(), WalletPage()],
                    ),
                    headerSliverBuilder:
