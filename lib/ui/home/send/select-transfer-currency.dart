...
class SelectTransferCurrencyBottomSheet extends StatefulWidget {
  Function(TransferCurrency)? onTap;
  TransferCurrency? old;
  String? title;
  SelectTransferCurrencyBottomSheet(
      {Key? key, this.onTap, this.old, this.title})
      : super(key: key);

  @override
  State<SelectTransferCurrencyBottomSheet> createState() =>
      _SelectTransferCurrencyBottomSheetState();
}

class _SelectTransferCurrencyBottomSheetState
    extends State<SelectTransferCurrencyBottomSheet> {
...
showSelectTransferCurrencyBottomSheet(BuildContext context,
    {Function(TransferCurrency)? onTap, TransferCurrency? old, String? title}) {
  showModalBottomSheet(
      ...
      builder: (context) {
        return SelectTransferCurrencyBottomSheet(
