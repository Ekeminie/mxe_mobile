...
class EditBillsBeneficiaryPage extends StatefulWidget {
  final AirtimeDataBeneficiaryResponse item;
  const EditBillsBeneficiaryPage({Key? key, required this.item})
      : super(key: key);

  @override
  State<EditBillsBeneficiaryPage> createState() =>
      _EditBillsBeneficiaryPageState();
}

class _EditBillsBeneficiaryPageState extends State<EditBillsBeneficiaryPage> {
  @override
  Widget build(BuildContext context) {
    return BaseView<BeneficiariesViewModel>(
      onModelReady: (m) => m.initAirtimeAndDataBeneficiary(widget.item),
