...
class VirtualCardWithdrawal extends StatefulWidget {
  const VirtualCardWithdrawal({Key? key}) : super(key: key);

  @override
  State<VirtualCardWithdrawal> createState() => _VirtualCardWithdrawalState();
}

class _VirtualCardWithdrawalState extends State<VirtualCardWithdrawal> {
    ...
    return BaseView<CardViewModel>(
      builder: (context, model, child) => Scaffold(
        ...
        body: Column(
          ...
          children: [
            header("Withdraw from Virtual Account"),
            Container(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        if (model.amount != 0) 8.sbH,
                        if (model.amount != 0)
                          Align(
                            alignment: Alignment.centerLeft,
                            child: AutoSizeText(
                              formatPrice((model.amount * 1000).toString()),
                            ...
                            showNewTransferPinBottomSheet(context,
                                ...
                                onDone: () => Navigator.pushNamed(
                                    ...
                                    arguments: SuccessData(
                                        ...
                                        title:
                                            "Your Virtual Card Withdrawal was Successful",
                                        transType: "Virtual Card Top-up",
                                        subTitle:
                                            "You have successfully withdrawn USD ${model.amount} from your Virtual Card")));
                          }
                        : null,
                  )
                ],
